...
def main():
    ...
    settings = {
        'default': {
            'model_fname': '3.1_cnn_model_default.npz',
            'stats_fname': '3.1_cnn_stats_default.npz',
            'eps': 0.1,
            'momentum': 0.0,
            'num_epochs': 30,
            'filter_size': 5,
        ...
        '3.3 - filters_4_8': {
            'model_fname': '3.3_cnn_model_filters_4_8.npz',
            'stats_fname': '3.3_cnn_stats_filters_4_8.npz',
            'eps': 0.1,
            'momentum': 0.9,
            'num_epochs': 30,
            'filter_size': 5,
        ...
        '3.3 - filters_8_16': {
            'model_fname': '3.3_cnn_model_filters_8_16.npz',
            'stats_fname': '3.3_cnn_stats_filters_8_16.npz',
            'eps': 0.1,
            'momentum': 0.9,
            'num_epochs': 30,
            'filter_size': 5,
        ...
        '3.3 - filters_16_32': {
            'model_fname': '3.3_cnn_model_filters_16_32.npz',
            'stats_fname': '3.3_cnn_stats_filters_16_32.npz',
            'eps': 0.1,
            'momentum': 0.9,
            'num_epochs': 30,
            'filter_size': 5,
    ...
    for key, setting in settings.items():
        # Initialize model.
        model = InitCNN(num_channels, setting['filter_size'], setting['num_filters_1'], setting['num_filters_2'],
                        num_outputs)
