...
from util import LoadData, Save, DisplayPlot
import numpy as np
...
def main():
    ...
    settings = {
        'default': {
            'model_fname': '3.1_nn_model_default.npz',
            'stats_fname': '3.1_nn_stats_default.npz',
            'num_hiddens': [16, 32],
            'eps': 0.01,
            'momentum': 0.0,
            'num_epochs': 1000,
        ...
        # '3.2 - batch_100 (default)': {
        #     'model_fname': '3.2_nn_model.npz',
        #     'stats_fname': '3.2_nn_stats.npz',
        #     'num_hiddens': [16, 32],
        #     'eps': 0.01,
        #     'momentum': 0.0,
        #     'num_epochs': 1000,
        ...
        '3.3 - hiddens_8_16': {
            'model_fname': '3.3_nn_model_hiddens_8_16.npz',
            'stats_fname': '3.3_nn_stats_hiddens_8_16.npz',
            'num_hiddens': [8, 16],
            'eps': 0.01,
            'momentum': 0.9,
            'num_epochs': 1000,
        ...
        '3.3 - hiddens_16_32': {
            'model_fname': '3.3_nn_model_hiddens_16_32.npz',
            'stats_fname': '3.3_nn_stats_hiddens_16_32.npz',
            'num_hiddens': [16, 32],
            'eps': 0.01,
            'momentum': 0.9,
            'num_epochs': 500,
        ...
        '3.3 - hiddens_48_96': {
            'model_fname': '3.3_nn_model_hiddens_48_96.npz',
            'stats_fname': '3.3_nn_stats_hiddens_48_96.npz',
            'num_hiddens': [48, 96],
            'eps': 0.01,
            'momentum': 0.9,
            'num_epochs': 300,
    ...
    for key, setting in settings.items():
        # Initialize model.
        model = InitNN(num_inputs, setting['num_hiddens'], num_outputs)
        ...
        # Train model.
        trained_model, stats = Train(model, NNForward, NNBackward, NNUpdate, setting['eps'],
        ...
        Save(setting['stats_fname'], stats)
